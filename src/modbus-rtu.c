 ...
 * Copyright � 2011 Guided Wave Inc.
 *
                         ...
                         int stop_bit)
{
    ...
    ctx->req_buffer = (uint8_t *) malloc(MODBUS_RTU_MAX_ADU_LENGTH * sizeof(uint8_t));
    ctx->rsp_buffer = (uint8_t *) malloc(MODBUS_RTU_MAX_ADU_LENGTH * sizeof(uint8_t));
